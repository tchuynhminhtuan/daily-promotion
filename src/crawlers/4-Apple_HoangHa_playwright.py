...
class HoangHaScraper(BaseScraper):
    ...
    def get_fieldnames(self):
        fields = [
            ...
            "Date", "Khuyen_Mai", "Thanh_Toan", "Store_Count", "Link"
        ]
    ...
    async def scrape_tech_specs(self, page):
        """Clicks 'view all specs' and scrapes the content"""
        try:
            # 1. Expand content
            expand_btn = page.locator("//div[@class='box-technical-specifications']//a")
            ...
            container = page.locator("//div[@class='box-technical-specifications']")
    ...
    async def scrape_variant(self, page, url, color_name, forced_price=None):
        # ... (start of existing scrape_variant logic)
