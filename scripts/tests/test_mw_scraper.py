#!/usr/bin/env python
"""
Test script for Mobile World scraper promotion extraction.
Outputs to 2-mw-test.csv instead of production file.
"""
import asyncio
import os
import sys
...
TEST_URLS = [
    ...
    "https://www.thegioididong.com/dtdd/iphone-13-xanh-la"
]

OUTPUT_FILE = "2-mw-test.csv"
